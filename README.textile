...
<code>people_table.dependent_foreign_keys.first.drop
people_table.dependent_foreign_keys.first.create</code>
...
<code>people_table.cluster('people_pk') #must specify an index by which to cluster</code>
